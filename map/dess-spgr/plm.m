...
%|  
%|  version control
%|    1.1       2016-08-18      adapted from mri_m0t1t2inveff_map(...)
%|    1.2       2016-09-18      project initialization onto box constraint
%|    1.3       2018-01-22      now passes weight vector instead of sparse weight matrix
