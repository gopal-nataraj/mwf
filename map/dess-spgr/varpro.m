...
%|                                1st field: latent parameter (m0,ff,t1f,t1s,t2f,t2s)
%|     .*.supp  [2]               [lb ub] distribution endpoints        
%|     .*.nsamp [1]               (varpro) number of dict samples      
...
%|    1.2       2016-08-21      now inputs vectorized y format
%|    2.1       2016-08-22      for large K, computes dictionary elements on the fly
%|    2.2       2016-09-02      switch dict object for dist object
