  function [ss_grad] = spgr_2comp_gradx(M0, ff, T1f, T1s, T2f, T2s,...
      kap, Dwf, Dws, flip, TR, TE, varargin)
%|function [ss_grad] = spgr_2comp_gradx(M0, ff, T1f, T1s, T2f, T2s,...
%|    kap, Dwf, Dws, flip, TR, TE, varargin)
%|
%|  2-compartment spgr signal gradient
%|    without exchange
...
%|
%|  outputs
%|    ss_grad   [(odims) L]     spgr signal gradient at time t=TE after RF
%|
%|  copyright 2016, gopal nataraj, university of michigan
%|
%|  version control
%|    1.1       2016-03-30      original
%|    1.2       2016-04-15      added options for without exchange
%|    1.3       2016-08-15      added magnitude signal option
%|    1.4       2016-08-17      exchg only turned on if nonzero kfs specified
