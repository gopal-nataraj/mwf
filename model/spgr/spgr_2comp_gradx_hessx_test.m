...
for i = 1:length(xf)
  ...
  % 2-compartment spgr signal gradients
  ssgradx = spgr_2comp_gradx(...
    tmp.M0, tmp.ff, tmp.T1f, tmp.T1s, tmp.T2f, tmp.T2s,...
    def.nu.kap, def.nu.Dwf, def.nu.Dws,...
    flip, TR, TE,...
    'exchg', bool.exchg,...
  ...
  % 2-compartment spgr signal hessians
  sshessx = spgr_2comp_hessx(...
    tmp.M0, tmp.ff, tmp.T1f, tmp.T1s, tmp.T2f, tmp.T2s,...
    def.nu.kap, def.nu.Dwf, def.nu.Dws,...
    flip, TR, TE,...
    'exchg', bool.exchg,...
